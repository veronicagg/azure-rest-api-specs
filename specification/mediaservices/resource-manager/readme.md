...
These settings apply only when `--tag=package-2018-99` is specified on the command line.

```yaml $(tag) == 'package-2018-99'
input-file:
  - Microsoft.Media/stable/2018-99-99/media.json
```
### Tag: package-2018-07
